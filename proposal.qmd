---
title: "Understanding Hospital Readmissions"
...
Objective: To identify the most significant demographic (age, medical specialty) and clinical factors (length of stay, number of procedures, etc.) that contribute to hospital readmissions.
...
Proposed Analysis:
1. Perform descriptive statistics and logistic regression analysis to identify predictors of readmission.
2. Create a correlation heatmap to visualize relationships among variables.
3. Use bar plots and box plots to explore differences in readmission rates across age groups and medical specialties.
...
Proposed Analysis:
[1.]{.underline} Conduct Chi-square tests for each diagnosis category to assess its impact on readmissions.
[2.]{.underline} Visualize results with bar plots comparing the proportion of readmissions for diabetic vs. non-diabetic patients.
[3.]{.underline} Highlight significant differences to guide healthcare interventions for diabetic patients.
...
-\`age\`
-\`medical_specialty\`
-\`time_in_hospital\`, \`n_medications\`, \`n_procedures\`
-\`diag_1\`, \`diag_2\`, \`diag_3\`
-\`diabetes_med\`, \`change\`
-\`readmitted\`

Proposed Analysis :
[1.]{.underline}Perform some predictive modelling like logistic regression/ random forestetcto identify key predictors of readmission.
